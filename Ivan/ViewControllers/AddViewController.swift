...
class AddViewController: UIViewController {
    ...
    @IBAction func addsuccess(_ sender: Any) {
        if addname.text == "" || addphone.text == "" {
            ...
            self.ref.child("Clients").child(uuid).setValue(["userName":name, "orderNo": timeInterval, "requestTime": timeLabel.text, "phoneNumber":phone, "uid": uuid, "state": "REQUESTED", "ready": false])
